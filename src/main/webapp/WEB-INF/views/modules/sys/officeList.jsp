			...
			for (var i=0; i<data.length; i++){
				...
				if ((${fns:jsGetVal('row.parentId')}) == pid){
					$(list).append(Mustache.render(tpl, {
						...
						dict2: {
							type: getDictLabel(${fns:toJson(fns:getDictList('ftype'))}, row.ftype)
...
<body>
	...
	<table id="treeTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>机构名称</th><th>归属区域</th><th>机构编码</th><th>机构类型</th><th>厂区类别</th><th>备注</th><shiro:hasPermission name="sys:office:edit"><th>操作</th></shiro:hasPermission></tr></thead>
