...
<ul class="nav nav-tabs">
	...
	<form:form id="inputForm" modelAttribute="dayReport" action="${ctx}/report/day/save" method="post" class="form-horizontal">
		...
		<table  class="table table-striped table-bordered table-condensed">
		  <tr>
		    <td>日期</td>
		    <td><input id="reportDate" name="reportDate" type="text" readonly="readonly" maxlength="50" class="input-mini Wdate"
		    ...
		    <td>天气</td>
		    <td><form:input path="weather" htmlEscape="false" maxlength="50" class="input-mini2 "/></td>
		    <td>温度</td>
		  ...
		  <tr>
		    <td>值班人员</td>
		    <td colspan="2">早班：<form:input path="earlyWorker" htmlEscape="false" maxlength="50" class="input-mini "/></td>
		    <td colspan="2">中班：<form:input path="middleWorker" htmlEscape="false" maxlength="50" class="input-mini "/></td>
		    <td colspan="3">晚班：<form:input path="lastWorker" htmlEscape="false" maxlength="50" class="input-mini "/></td>
		  </tr>
		  <tr>
