			  ...
			  <c:when test="${inOverproofList.size()>0}">
				  <c:forEach items="${inOverproofList}" var="inOverproof">
					   <tr>
					    ...
					    <td><input type="text" id="inDate" name ="inDate" value="${inOverproof.occurDate}" htmlEscape="false" maxlength="20" class="input-mini " /></td><!-- readonly="readonly" -->
			  ...
			  <tr>
			   ...
			   <c:when test="${outOverproofList.size()>0}">
				  <c:forEach items="${outOverproofList}" var="outOverproof">
					   <tr>
					    <td style="display:none;"><input type="text" id="outId" name ="outId" value="${outOverproof.id}" htmlEscape="false" maxlength="20" class="input-mini "/></td><!-- readonly="readonly" -->
